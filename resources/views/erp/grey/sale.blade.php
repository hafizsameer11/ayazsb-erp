    ...
    <div class="flex min-h-[calc(100vh-8rem)] flex-col">
        <div class="erp-panel shrink-0 border border-slate-500 bg-white shadow-md">
            ...
            <form class="space-y-2 p-3" data-erp-ajax-save data-grey-totals-form @if($editingTransaction) data-erp-editing="1" @endif
                ...
                @endif
                @include('erp.grey.partials.purchase-sale-master', ['direction' => 'sale', 'editingTransaction' => $editingTransaction, 'meta' => $meta, 'line0' => $line0])
                @include('erp.grey.partials.voucher-strip', ['meta' => $meta])
                @include('erp.grey.partials.sale-details-section', ['detailLines' => $detailLines, 'line0' => $line0, 'meta' => $meta])
                @include('erp.grey.partials.sale-report-grid', ['reportRows' => $reportRows, 'meta' => $meta])
