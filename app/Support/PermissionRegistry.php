...
class PermissionRegistry
{
    ...
    public static function routePermissionMap(): array
    {
        return [
            ...
            'erp.accounts.opening.update' => 'accounts.opening.edit',
            'erp.accounts.opening.destroy' => 'admin.records.delete',
            'erp.accounts.vouchers.update' => 'accounts.vouchers.jv.edit',
            'erp.accounts.vouchers.destroy' => 'admin.records.delete',
            'erp.yarn.screen.destroy' => 'admin.records.delete',
            'erp.yarn.screen.contract.destroy' => 'admin.records.delete',
            'erp.grey.screen.destroy' => 'admin.records.delete',
            'erp.grey.screen.contract.destroy' => 'admin.records.delete',
            'erp.grey.master-data' => 'grey.master-data.view',
            'erp.grey.master-data.store' => 'grey.master-data.create',
            'erp.grey.master-data.quality.destroy' => 'grey.master-data.delete',
            'erp.grey.screen.contract.update' => 'grey.conversion-contract.edit',
            'erp.yarn.screen.update' => 'yarn.screen.edit',
            'erp.yarn.screen.contract.update' => 'yarn.screen.edit',
            'erp.grey.screen.update' => 'grey.screen.edit',
            ...
            'erp.yarn.master-data' => 'yarn.master-data.view',
            'erp.yarn.master-data.store' => 'yarn.master-data.create',
    ...
    private static function moduleScreens(): array
    {
        return [
            ...
            'weaving' => \App\Support\WeavingModule::screenSlugs(),
            'reports' => [
                'accounts',
                'yarn',
                'grey',
